...
export default function Comentar({ onSubmitComentario, mostrarError }) {
	...
	return (
		<form onSubmit={onSubmit} className="Post__comentario-form-container">
			<input type="text" placeholder="Deja un comentario..." required maxLength="180" value={mensaje} onChange={e => setMensaje(e.target.value)} />
